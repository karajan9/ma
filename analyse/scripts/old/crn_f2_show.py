...
def plot_data(tm, cmplx):
    plt.xscale("log")
    plt.scatter(tm, cmplx.real, marker="x")
    # plt.scatter(tm, cmplx.real, label="real", color="b", marker="x")
    # plt.scatter(tm, cmplx.imag, label="imag", color="r", marker="x")
    # plt.plot(np.sort(tm), f2(np.sort(tm), p[0], p[1], p[2], p[3]))
...
def show_plot():
    ...
    fn_save = "/home/jens/Documents/projekte/crn/170706/plots/t1_vergleich.pdf"
    # plt.savefig(fn_save, bbox_inches="tight")
    plt.show()



# directory = "/home/jens/Documents/projekte/crn/170710/F2COS/280K/1298_CRN_F2_280K"
# os.chdir(directory)
...
home_dir = "/home/jens/Documents/projekte/crn/170710/F2COS/290K"
