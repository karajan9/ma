...
# import glob  # , os
from nmr_lib import save_plot, show_plot
...
def do_t1_bruker():
    ...
    for i, file_name in enumerate(t1dir):
        ...
        plt.errorbar(temp, 1 / t1, yerr=t1_err / t1**2, fmt='.', color="blue")

    bruker_name = "/home/jens/Documents/projekte/crn/data/T1/bruker_t1.data"
    ...
    save_plot("/home/jens/Documents/projekte/crn/data/T1/t1_bruker")
