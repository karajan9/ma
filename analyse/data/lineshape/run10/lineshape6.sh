...
# declare -a arr=("3.01034286e-07" "1.52834946e-07" "1.23509129e-07" "1.00411106e-07" "8.21035899e-08" "6.75052576e-08" "3.86980325e-08" "8.01593435e-09")
declare -a arr=("3.01034286e-07")
for i in "${arr[@]}"
	do
		lifetime=$i
		basename="lineshape_lifetime!${lifetime}!"
