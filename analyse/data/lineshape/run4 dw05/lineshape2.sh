...
declare -a arr=("1.74010323e-05" "9.84301523e-06" "5.71385066e-06" "3.39803118e-06" "1.28421361e-06" "8.13857111e-07" "5.25465644e-07" "3.45255530e-07")
# declare -a arr=("3.45255530e-07")
for i in "${arr[@]}"
	do
		lifetime=$i
		basename="lineshape_lifetime!${lifetime}!"
