...
# numtrajectories=10000000000
numtrajectories=100000000
# storeinterval: save data after calculationg n trajectories
storeinterval=10000000
...
# declare -a arr=("1.00411e-7" "3.01034e-7" "1.08049e-6" "4.87227e-6" "2.95189e-5" "2.64575e-4" "0.00404858")
declare -a arr=("2.64575e-4" "0.00404858")
for i in "${arr[@]}"
	do
		lifetime=$i
		basename="lineshape_lifetime!${lifetime}!"
