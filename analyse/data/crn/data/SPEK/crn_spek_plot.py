...
def plot_spek_multi():
    ...
    for i, fn_spek in enumerate(
            sorted(glob.glob(directory + "/*/*.spec.nmr"))):
        ...
        plt.plot(
            freq / 1e3,
            cmplx.real / cmplx.real.max() - i * 0.75,
            label=labels[i],
            color="b")
        plot_setup()
        try:
...
plot_fwhm()
save_plot("/home/jens/Documents/projekte/crn/data/SPEK/fwhm")
show_plot()
