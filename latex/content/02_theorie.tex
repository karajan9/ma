...
Es ist anzumerken, dass in der ersten Ordnung $H_Q$ nur vom Quadrat von $m$ abhängt und der Zentrallinienübergang von $-\sfrac{1}{2} \to \sfrac{1}{2}$ daher keine Korrektur erfährt. Dies ändert sich mit Betrachtung der zweiten Ordnung, was bei einer großen Stärke der Quadrupol-Wechselwirkung geschehen muss. Für diese gilt folgende Korrektur der Zentrallinie \cite{man_quadrupole_2000}:
\begin{align}
    \begin{split}
